...
export const TracingList = () => {
  ...
  const callsFilter = callState.list.filter(call => {
    return call.deal && call.deal.progressPayment && call.deal.progressPayment.ref === "6082e45d9f372e5c92a5a291"
  })
  ...
  return (
    <>
      <HeaderSection title='Seguimiento'>
...
const getColumns = (list, handleDelete) => [
  ...
  {
    title: 'Estado contabilidad',
    dataIndex: 'statusPayment',
    ...SearchRow('statusPayment')
  },
  {
    title: 'Email',
    dataIndex: 'email',
